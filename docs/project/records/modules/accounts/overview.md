---
{"id":"MOD-accounts","kind":"module","title":"CPA 账号与固定代理","status":"current","summary":"在 GPT 设置区管理多个登录账号，显式指定一个代理账号；失败不换号，凭据由 CPA 保管。","progress":"in_progress","relations":[{"relation":"consumes","to":{"record_id":"MOD-provider"},"reason":"原生请求捕获账号身份并隔离加密重放范围"}]}
---
